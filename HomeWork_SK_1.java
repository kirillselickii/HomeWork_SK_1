...
//by tag name
      ...
      WebElement btn7 = wd.findElement(By.tagName("h1"));
      WebElement btn8 = wd.findElement(By.cssSelector("h1"));
...
//by class
      ...
      WebElement bc3 = wd.findElement(By.className("navbar-component_nav__1X_4mr"));
      WebElement bc4 = wd.findElement(By.cssSelector(".navbar-component_nav__1X_4m"));
      WebElement bc5 = wd.findElement(By.className("active"));
      WebElement bc6 = wd.findElement(By.cssSelector(".active"));
      WebElement bc7 = wd.findElement(By.className("login_login__3EHKB"));
      WebElement bc8 = wd.findElement(By.cssSelector(".login_login__3EHKB"));
//By ID
